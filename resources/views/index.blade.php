    ...
    <div class="container small border-top">
      <div class="row py-5 d-flex justify-content-between">
        ...
        <div class="col-12 col-lg-6 col-xl-3 p-5">
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link link-secondary ps-0" aria-current="page" href="{{url('/404')}}">404 System Page</a>
              <a class="nav-link link-secondary ps-0" aria-current="page" href="{{url('/register')}}">Register System Page</a>
              <a class="nav-link link-secondary ps-0" aria-current="page" href="{{url('/content')}}">Simple Text Content
                Page</a>
            </li>
          </ul>
        </div>
